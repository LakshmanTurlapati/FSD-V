...
![Cybertruck](https://img.shields.io/badge/Cybertruck-CyberTruckV-38BDF8?style=for-the-badge)
...
```text
1. Copy scripts into <GTA V install folder>\scripts
